#[doc = "Register `ADCREFTRIM2` reader"]
pub type R = crate::R<Adcreftrim2Spec>;
#[doc = "Register `ADCREFTRIM2` writer"]
pub type W = crate::W<Adcreftrim2Spec>;
...
impl W {
    #[doc = "Bits 0:6 - Trimming code for VREFP output of reference buffer"]
    #[inline(always)]
    pub fn vrefp(&mut self) -> VrefpW<'_, Adcreftrim2Spec> {
        VrefpW::new(self, 0)
    }
    #[doc = "Bits 8:14 - Trimming code for VREFM output of reference buffer"]
    #[inline(always)]
    pub fn vrefm(&mut self) -> VrefmW<'_, Adcreftrim2Spec> {
        VrefmW::new(self, 8)
    }
    #[doc = "Bits 16:17 - Trimming code for VCM output of reference buffer"]
    #[inline(always)]
    pub fn vcm(&mut self) -> VcmW<'_, Adcreftrim2Spec> {
        VcmW::new(self, 16)
    }
    #[doc = "Bits 24:29 - Controls tuning capacitor in fine DAC (offset binary)"]
    #[inline(always)]
    pub fn vx2_tune(&mut self) -> Vx2TuneW<'_, Adcreftrim2Spec> {
        Vx2TuneW::new(self, 24)
    }
}
#[doc = "Temp Sensor trim1\n\nYou can [`read`](crate::Reg::read) this register and get [`adcreftrim2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adcreftrim2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Adcreftrim2Spec;
impl crate::RegisterSpec for Adcreftrim2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`adcreftrim2::R`](R) reader structure"]
impl crate::Readable for Adcreftrim2Spec {}
#[doc = "`write(|w| ..)` method takes [`adcreftrim2::W`](W) writer structure"]
impl crate::Writable for Adcreftrim2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ADCREFTRIM2 to value 0"]
impl crate::Resettable for Adcreftrim2Spec {}
