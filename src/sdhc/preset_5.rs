#[doc = "Register `PRESET_5` reader"]
pub type R = crate::R<Preset5Spec>;
...
#[doc = "Preset Value for SDR50.\n\nYou can [`read`](crate::Reg::read) this register and get [`preset_5::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Preset5Spec;
impl crate::RegisterSpec for Preset5Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`preset_5::R`](R) reader structure"]
impl crate::Readable for Preset5Spec {}
#[doc = "`reset()` method sets PRESET_5 to value 0"]
impl crate::Resettable for Preset5Spec {}
