...
#[doc = "Preset Value for High Speed.\n\nYou can [`read`](crate::Reg::read) this register and get [`preset_2::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Preset2Spec;
impl crate::RegisterSpec for Preset2Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`preset_2::R`](R) reader structure"]
impl crate::Readable for Preset2Spec {}
#[doc = "`reset()` method sets PRESET_2 to value 0"]
