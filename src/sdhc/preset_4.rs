#[doc = "Register `PRESET_4` reader"]
pub type R = crate::R<Preset4Spec>;
...
#[doc = "Preset Value for SDR25.\n\nYou can [`read`](crate::Reg::read) this register and get [`preset_4::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Preset4Spec;
impl crate::RegisterSpec for Preset4Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`preset_4::R`](R) reader structure"]
impl crate::Readable for Preset4Spec {}
#[doc = "`reset()` method sets PRESET_4 to value 0"]
impl crate::Resettable for Preset4Spec {}
