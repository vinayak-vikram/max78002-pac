#[doc = "Register `PRESET_7` reader"]
pub type R = crate::R<Preset7Spec>;
...
#[doc = "Preset Value for DDR50.\n\nYou can [`read`](crate::Reg::read) this register and get [`preset_7::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Preset7Spec;
impl crate::RegisterSpec for Preset7Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`preset_7::R`](R) reader structure"]
impl crate::Readable for Preset7Spec {}
#[doc = "`reset()` method sets PRESET_7 to value 0"]
impl crate::Resettable for Preset7Spec {}
