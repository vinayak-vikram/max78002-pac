...
#[doc = "Preset Value for Default Speed.\n\nYou can [`read`](crate::Reg::read) this register and get [`preset_1::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Preset1Spec;
impl crate::RegisterSpec for Preset1Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`preset_1::R`](R) reader structure"]
impl crate::Readable for Preset1Spec {}
#[doc = "`reset()` method sets PRESET_1 to value 0"]
