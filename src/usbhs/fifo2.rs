...
#[doc = "Field `USBHS_FIFO2` reader - USBHS Endpoint FIFO Read/Write Register."]
pub type UsbhsFifo2R = crate::FieldReader<u32>;
#[doc = "Field `USBHS_FIFO2` writer - USBHS Endpoint FIFO Read/Write Register."]
pub type UsbhsFifo2W<'a, REG> = crate::FieldWriter<'a, REG, 32, u32>;
impl R {
    #[doc = "Bits 0:31 - USBHS Endpoint FIFO Read/Write Register."]
    #[inline(always)]
    pub fn usbhs_fifo2(&self) -> UsbhsFifo2R {
        UsbhsFifo2R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - USBHS Endpoint FIFO Read/Write Register."]
    #[inline(always)]
    pub fn usbhs_fifo2(&mut self) -> UsbhsFifo2W<'_, Fifo2Spec> {
        UsbhsFifo2W::new(self, 0)
    }
}
