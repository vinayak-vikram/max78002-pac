...
impl W {
    #[doc = "Bit 0 - Image Done."]
    #[inline(always)]
    pub fn img_done(&mut self) -> ImgDoneW<'_, IntFlSpec> {
        ImgDoneW::new(self, 0)
    }
    #[doc = "Bit 1 - FIFO Full."]
    #[inline(always)]
    pub fn fifo_full(&mut self) -> FifoFullW<'_, IntFlSpec> {
        FifoFullW::new(self, 1)
    }
    #[doc = "Bit 2 - FIFO Threshold Level Met."]
    #[inline(always)]
    pub fn fifo_thresh(&mut self) -> FifoThreshW<'_, IntFlSpec> {
        FifoThreshW::new(self, 2)
    }
    #[doc = "Bit 3 - FIFO Not Empty."]
    #[inline(always)]
    pub fn fifo_not_empty(&mut self) -> FifoNotEmptyW<'_, IntFlSpec> {
