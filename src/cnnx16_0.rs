...
impl RegisterBlock {
    ...
    #[doc = "0x0c - Register clear and memory BIST control. Run bits are write-1, then poll the matching done bit, then write zero to reset. Bits 13 to 11 are engine-coupled qualifiers that cannot be varied independently; use the documented composite command values."]
    #[inline(always)]
