...
impl W {
    #[doc = "Bit 0 - CRC error."]
    #[inline(always)]
    pub fn crc(&mut self) -> CrcW<'_, IrqClrSpec> {
        CrcW::new(self, 0)
    }
    #[doc = "Bit 1 - Single bit ECC error."]
    #[inline(always)]
    pub fn sbe(&mut self) -> SbeW<'_, IrqClrSpec> {
        SbeW::new(self, 1)
    }
    #[doc = "Bit 2 - Multiple bit ECC error."]
    #[inline(always)]
    pub fn mbe(&mut self) -> MbeW<'_, IrqClrSpec> {
        MbeW::new(self, 2)
    }
    #[doc = "Bit 3 - ULPS active status change."]
    #[inline(always)]
    pub fn ulps_active(&mut self) -> UlpsActiveW<'_, IrqClrSpec> {
        UlpsActiveW::new(self, 3)
    }
    #[doc = "Bit 4 - ULPS mark active status change."]
    #[inline(always)]
    pub fn ulps_mark_active(&mut self) -> UlpsMarkActiveW<'_, IrqClrSpec> {
        UlpsMarkActiveW::new(self, 4)
    }
    #[doc = "Bit 5 - Video Error Send Level."]
    #[inline(always)]
    pub fn vid_err_send_lvl(&mut self) -> VidErrSendLvlW<'_, IrqClrSpec> {
        VidErrSendLvlW::new(self, 5)
    }
    #[doc = "Bit 6 - Video Error Fifo Overflow."]
    #[inline(always)]
    pub fn vid_err_fifo_wr_ov(&mut self) -> VidErrFifoWrOvW<'_, IrqClrSpec> {
        VidErrFifoWrOvW::new(self, 6)
    }
}
#[doc = "IRQ_CLR.\n\nYou can [`read`](crate::Reg::read) this register and get [`irq_clr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`irq_clr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
