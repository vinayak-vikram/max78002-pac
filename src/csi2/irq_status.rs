...
impl W {
    #[doc = "Bit 0 - CRC error."]
    #[inline(always)]
    pub fn crc(&mut self) -> CrcW<'_, IrqStatusSpec> {
        CrcW::new(self, 0)
    }
    #[doc = "Bit 1 - Single bit ECC error."]
    #[inline(always)]
    pub fn sbe(&mut self) -> SbeW<'_, IrqStatusSpec> {
        SbeW::new(self, 1)
    }
    #[doc = "Bit 2 - Multiple bit ECC error."]
    #[inline(always)]
    pub fn mbe(&mut self) -> MbeW<'_, IrqStatusSpec> {
        MbeW::new(self, 2)
    }
    #[doc = "Bit 3 - ULPS active status change."]
    #[inline(always)]
    pub fn ulps_active(&mut self) -> UlpsActiveW<'_, IrqStatusSpec> {
        UlpsActiveW::new(self, 3)
    }
    #[doc = "Bit 4 - ULPS mark active status change."]
    #[inline(always)]
    pub fn ulps_mark_active(&mut self) -> UlpsMarkActiveW<'_, IrqStatusSpec> {
        UlpsMarkActiveW::new(self, 4)
    }
    #[doc = "Bit 5 - Video Error Send Level."]
    #[inline(always)]
    pub fn vid_err_send_lvl(&mut self) -> VidErrSendLvlW<'_, IrqStatusSpec> {
        VidErrSendLvlW::new(self, 5)
    }
    #[doc = "Bit 6 - Video Error Fifo Overflow."]
    #[inline(always)]
    pub fn vid_err_fifo_wr_ov(&mut self) -> VidErrFifoWrOvW<'_, IrqStatusSpec> {
